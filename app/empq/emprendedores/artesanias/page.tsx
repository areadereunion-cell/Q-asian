...
export default function ArtesaniasPage() {
  const entrepreneurs = emprendedores.artesanias ?? [];
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#F7FAFD] resident-font">
      <div className="pointer-events-none absolute inset-0 z-0">
        ...
        <div className="absolute right-[7%] top-[28%] h-3 w-3 rounded-full bg-[#D71920] opacity-60" />
      ...
      >
        ...
        >
          ...
          >
            ...
            artesanías y conoce el talento detrás de cada proyecto.
          </p>

          <div className="mt-7 flex items-center gap-3">
            <span className="h-[3px] w-12 rounded-full bg-[#D9822B]" />
            <span className="h-2 w-2 rounded-full bg-[#D9822B]" />
            <span className="h-px w-8 bg-[#D9822B]/20" />
          </div>
        </motion.header>
              ...
              >
                ...
                >
                  ...
                  <div className="absolute bottom-5 left-6 right-6">
                    <div className="mb-2 h-[3px] w-9 rounded-full bg-[#D9822B]" />
                    ...
                    >
                      <span
                        className="
                          ...
                          hover:-translate-y-0.5
                          hover:bg-[#D9822B]
                          hover:shadow-[0_9px_22px_rgba(217,130,43,0.2)]
                        "
                      >
                        Contactar
                      </span>
