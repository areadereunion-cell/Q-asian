...
export default function DulcesPage() {
  const entrepreneurs = emprendedores.dulces ?? [];
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            Descubre los emprendimientos de nuestra categoría de dulces.
          </p>

          <div className="mt-7 flex items-center gap-3">
            <span className="h-[3px] w-10 rounded-full bg-[#7654A3]" />
            <span className="h-2 w-2 rounded-full bg-[#7654A3]" />
          </div>
        </motion.header>
