...
export default function RopaPage() {
  const entrepreneurs = emprendedores.ropa ?? [];
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            Descubre los emprendimientos de nuestra categoría de ropa.
          </p>

          <div className="mt-7 flex items-center gap-3">
            <span className="h-[3px] w-10 rounded-full bg-[#3F8C63]" />
            <span className="h-2 w-2 rounded-full bg-[#3F8C63]" />
          </div>
        </motion.header>
